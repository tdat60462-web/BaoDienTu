...
<body>
    ...
    <div style="max-width:400px;margin:40px auto 0 auto;background:#fff;padding:24px;border-radius:8px;box-shadow:0 2px 8px #eee;">
        ...
        <form method="post" action="/change-password">
            ...
            <input type="password" name="oldPassword" placeholder="Mật khẩu cũ" required style="width:100%;margin-bottom:10px;padding:8px;">
            <input type="password" name="newPassword" placeholder="Mật khẩu mới" required style="width:100%;margin-bottom:10px;padding:8px;">
            <input type="password" name="confirmPassword" placeholder="Xác nhận mật khẩu mới" required style="width:100%;margin-bottom:10px;padding:8px;">
            <button type="submit" style="width:100%;padding:8px;background:#1aaf5d;color:#fff;border:none;border-radius:4px;">Đổi mật khẩu</button>
        </form>
    </div>
</body>
</html>
