...
<body>
     ...
     <!-- ĐĂNG NHẬP/ĐĂNG KÝ/ĐỔI MẬT KHẨU/ĐĂNG XUẤT -->
    <div style="max-width:400px;margin:40px auto 0 auto;background:#fff;padding:24px;border-radius:8px;box-shadow:0 2px 8px #eee;">
        ...
        <form method="post" action="/login">
            ...
            <button type="submit" style="width:100%;padding:8px;background:#1aaf5d;color:#fff;border:none;border-radius:4px;">Đăng nhập</button>
        </form>
        <div style="margin-top:10px;text-align:center;">
            <a href="/baoDT/views/register.jsp">Đăng ký tài khoản mới</a> | <a href="/baoDT/views/change-password.jsp">Đổi mật khẩu</a></a>
        </div>
    </div>
</body>
</html>